...
class test(unittest.TestCase):
    ...
    def testGetAcotrsSucces(self):
        ...
        res = self.client().get(
            '/actors', headers={'Authorization': self.castingAssistantToken})
        self.assertEqual(res.status_code, 200)

    def testGetAcotrsFaliure(self):
        """ testGetAcotrsFaliure"""
        res = self.client().get(
            '/actorr', headers={'Authorization': self.castingAssistantToken})
    ...
    def testGetMoviesSucces(self):
        """ testGetMoviesSucces"""
        res = self.client().get(
            '/movies', headers={'Authorization': self.castingAssistantToken})
    ...
    def testGetMoviesFaliure(self):
        ...
        res = self.client().get(
            '/moivee', headers={'Authorization': self.castingAssistantToken})
    ...
    def testPostActorsSuccess(self):
        ...
        res = self.client().post(
            '/actor', headers={'Authorization': self.castingDirctorToken},
            json=self.newActor)
    ...
    def testPostMoviesSuccess(self):
        ...
        res = self.client().post(
            '/movie', headers={'Authorization': self.executiveProducerToken},
            json=self.newMovie)
    ...
    def testPatchActorsSuccess(self):
        ...
        res = self.client().patch(
            '/actor/4', headers={'Authorization': self.castingDirctorToken},
    ...
    def testPatchActorsFaliure(self):
        ...
        res = self.client().patch(
            '/actor/2', headers={'Authorization': self.castingDirctorToken},
            json=self.updatedActorFali)
        self.assertEqual(res.status_code, 422)

    def testPatchMoviesSuccess(self):
        """ testPatchMoviesSuccess"""
        res = self.client().patch(
            '/movie/3', headers={'Authorization': self.castingDirctorToken},
            json=self.updatedMoive)
    ...
    def testPatchMoivesFaliure(self):
        ...
        res = self.client().patch(
            '/movie/9997', headers={'Authorization': self.castingDirctorToken},
            json=self.updatedMoive)
        self.assertEqual(res.status_code, 404)
    ...
    def testDeleteActorsSuccess(self):
        ...
        res = self.client().delete(
            '/actor/1', headers={'Authorization': self.castingDirctorToken})
    ...
    def testDeleteActorsFaliure(self):
        ...
        res = self.client().delete(
            '/actor/9997', headers={'Authorization': self.castingDirctorToken})
        self.assertEqual(res.status_code, 404)

    def testDeleteMoviesSuccess(self):
        """ testDeleteMoviesSuccess"""
        res = self.client().delete(
            '/movie/1', headers={'Authorization': self.executiveProducerToken})
        self.assertEqual(res.status_code, 200)

    def testDeleteMoivesFaliure(self):
        """ testDeleteMoivesFaliure"""
        res = self.client().delete(
            '/movie/9', headers={'Authorization': self.executiveProducerToken})
        self.assertEqual(res.status_code, 404)

    def testCastingAssistantFail(self):
        """ Test patch Actors with casting assistant"""
        res = self.client().patch(
            '/actor/2', headers={'Authorization': self.castingAssistantToken},
            json=self.updatedActor)
    ...
    def testCastingDirctorFail(self):
        ...
        res = self.client().delete(
            '/movie/2', headers={'Authorization': self.castingDirctorToken})
